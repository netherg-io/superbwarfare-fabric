...
class MediumVehicleContainerMenu(id: Int, inventory: Inventory, entityId: Int) :
    ...
    companion object {
        ...
        @JvmField
        val TYPE: MenuType<MediumVehicleContainerMenu> = ExtendedScreenHandlerType<MediumVehicleContainerMenu, Int>(
            { id, inventory, entityId -> MediumVehicleContainerMenu(id, inventory, entityId) },
