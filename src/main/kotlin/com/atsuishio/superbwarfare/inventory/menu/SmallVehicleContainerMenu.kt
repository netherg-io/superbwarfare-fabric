...
class SmallVehicleContainerMenu(id: Int, inventory: Inventory, entityId: Int) :
    ...
    companion object {
        ...
        @JvmField
        val TYPE: MenuType<SmallVehicleContainerMenu> = ExtendedScreenHandlerType<SmallVehicleContainerMenu, Int>(
            { id, inventory, entityId -> SmallVehicleContainerMenu(id, inventory, entityId) },
